...
import { removeFromWatchlist } from '../../state/actions/profileActions';

class WatchlistItem extends Component {

    handleClick = () => {
        this.props.removeFromWatchlist(this.props.accountId, this.props.sessionId, this.props.movie.id);
        this.props.rerender()
    }
...
export default connect(mapStateToProps, { removeFromWatchlist })(WatchlistItem);